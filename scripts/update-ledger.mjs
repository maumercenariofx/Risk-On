...
function loadLedger() {
  if (!existsSync(OUT)) return { horizon: HORIZON, neutral_band: NEUTRAL_BAND, entries: {} };
  try {
    const l = JSON.parse(readFileSync(OUT, "utf8"));
    return { horizon: HORIZON, neutral_band: NEUTRAL_BAND, entries: l.entries ?? {} };
  } catch (e) {
