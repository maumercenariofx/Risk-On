    ...
    <div style={{ ...cardStyle(netLong), padding: "16px 18px", transition: "border-color .4s" }}>
      ...
      <div style={{ margin: "14px 0 6px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginTop: 6 }}>
          <span style={{ fontSize: 8, color: "#374151", fontFamily: "var(--font-mono)", letterSpacing: 1 }}>
            <T es="CORTO EX." en="EX. SHORT" />
          </span>
          <span style={{ fontSize: 8, letterSpacing: 1.5, fontFamily: "var(--font-mono)", color: crowd.color, fontVariantNumeric: "tabular-nums" }}>
      ...
      <div style={{ fontSize: 9, color: "#374151", marginTop: 8, fontFamily: "var(--font-mono)" }}>
