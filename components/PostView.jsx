...
export default function PostView({ post }) {
  ...
  return (
    <article className="space-y-5 pt-4">
      <Link href="/archive" className="text-sm text-gold hover:translate-x-1 inline-block transition-transform">
        ← <T es="Archivo" en="Archive" />
      </Link>
      <div className="reveal flex items-center gap-4">
        <div className="flex flex-col items-center rounded-xl border border-gold/25 px-4 py-2">
