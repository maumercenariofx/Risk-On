    ...
    <section className="reveal" style={{ animationDelay: "0.25s" }}>
      ...
      >
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: "16px 20px", marginBottom: 16 }}>
          {items.map((item, i) => (
            <div key={i}>
              <div style={{ fontSize: 9.5, letterSpacing: 1.5, textTransform: "uppercase", color: "#4A4A50", marginBottom: 5 }}>
              ...
              {item.sub && (
                <div style={{ fontSize: 9.5, color: "#3A3A3E", fontFamily: "var(--font-mono)", marginTop: 4 }}>
                  {item.sub}
                </div>
              )}
            </div>
        ...
        <div style={{ borderTop: "1px solid #141416", paddingTop: 14 }}>
          {spread != null && (
            <>
              <div style={{ fontSize: 9.5, letterSpacing: 2, textTransform: "uppercase", color: "#3A3A3E", marginBottom: 6 }}>
