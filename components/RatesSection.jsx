...
export default function RatesSection() {
  ...
  const items = [
    ...
    {
      label_es: "Diferencial MX–US",
      label_en: "MX–US Spread",
      value: "+" + spread + "%",
      highlight: true,
    },
  ];
  ...
  return (
    <section className="reveal" style={{ animationDelay: "0.25s" }}>
      ...
      <div style={{ background: "#0B0B0C", border: "1px solid #1E1E20", borderRadius: 12, padding: "18px 20px" }}>
        <div style={{
          display: "grid",
        ...
        <div style={{ borderTop: "1px solid #141416", paddingTop: 14 }}>
          ...
          <p style={{ fontSize: 12, color: "#5A5A60", lineHeight: 1.75 }}>
            <T
              ...
              en={`The +${spread}% spread (Banxico vs Fed) makes the peso attractive for carry trades: investors borrow dollars at low rates and place that money in pesos at high rates, pocketing the difference. That demand supports the peso — until risk spikes and everyone exits at once.`}
            />
          </p>
        </div>
      </div>
