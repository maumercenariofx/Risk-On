...
function FXCard({ label, price, chg, decimals }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ fontSize: 11, letterSpacing: 2, textTransform: "uppercase", color: "#8A8A8E", marginBottom: 6, fontFamily: "var(--font-mono)" }}>
        {label}
      </div>
  ...
  return (
    <section className="reveal" style={{ animationDelay: "0.3s" }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 11, letterSpacing: 3, textTransform: "uppercase", color: "#8A8A8E", marginBottom: 10 }}>
              ...
              return (
                <>
                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
                    <div>
                      <div style={{ fontSize: 11, color: "#8A8A8E", letterSpacing: 1.5, textTransform: "uppercase", marginBottom: 4, fontFamily: "var(--font-mono)" }}>
