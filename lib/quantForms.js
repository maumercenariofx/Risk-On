...
// Volatility cone: the range of possible prices opens with sigma*sqrt(T) —
// a classic GBM-dispersion cone (longer horizon = wider range of outcomes).
export function genVolCone(n, cols, rows) {
  const pos = new Float32Array(n * 3);
  for (let row = 0; row < rows; row++) {
    for (let col = 0; col < cols; col++) {
      ...
      const T      = 0.05 + v * 2.0;   // time to maturity (years)
...
export const FORMS = [
  ...
  {
    id: "VOLCONE",
    label_es: "Cono de Volatilidad", label_en: "Volatility Cone",
    formula: "σ√T",
    es: "El rango de precios posibles se abre con la raíz del tiempo (σ√T): mientras más lejano el horizonte, mayor la incertidumbre. Por eso las opciones de mayor vencimiento cuestan más — cubren un cono de resultados más ancho.",
    en: "The range of possible prices widens with the square root of time (σ√T): the farther the horizon, the greater the uncertainty. That's why longer-dated options cost more — they cover a wider cone of outcomes.",
  },
  {
    id: "SADDLE",
