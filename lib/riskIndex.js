...
export function riskLabel(score) {
  if (score >= 85) return { es: "Risk-on total",    en: "Full risk-on",      color: "#0F6E56" };
  if (score >= 70) return { es: "Risk-on fuerte",   en: "Strong risk-on",    color: "#2E9E6E" };
  if (score >= 58) return { es: "Risk-on",          en: "Risk-on",           color: "#639922" };
  if (score >= 42) return { es: "Neutral",          en: "Neutral",           color: "#BA7517" };
  if (score >= 25) return { es: "Risk-off",         en: "Risk-off",          color: "#D85A30" };
  return               { es: "Risk-off extremo", en: "Extreme risk-off", color: "#A32D2D" };
}
