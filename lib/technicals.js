...
// VENTANA CANÓNICA. Hasta el 21-ago-2026 el producto publicaba DOS niveles
// distintos bajo la misma etiqueta "Soporte / Resistencia": el correo y el view
// usaban 10 días (vía un rollingLevels duplicado en app/api/market/route.js) y
// /analisis usaba 20. Mismo par, misma fuente, dos verdades. Se unifica en 10 —
// la ventana del correo, que es la superficie que define la promesa del
// producto— y la función duplicada se borró.
export const LEVELS_PERIOD = 10;

export function levels(highs, lows, period = LEVELS_PERIOD) {
