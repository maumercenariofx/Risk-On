...
Busca en la web y devuelve un resumen FACTUAL en bullets (máximo 250 palabras):
1. Datos económicos publicados ESTA MAÑANA o anoche — actual vs consenso vs previo, con la hora. Eventos que el calendario esperaba estos días: ${hi}. Si un dato salió hace minutos, es LA noticia: consíguelo.
2. Noticias de las últimas 12-18 horas que muevan riesgo/tasas/peso (Fed, Banxico, geopolítica, commodities, EM).

Reglas: SOLO hechos con número y hora; si un dato de hoy AÚN no se publica, dilo explícitamente ("CPI sale a las 6:30, aún no publicado"); cero opiniones o recomendaciones; si no encuentras algo, no lo inventes.`,
      }],
    });
