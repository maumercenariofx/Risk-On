...
export const SIGNALS = [
  ...
  },
  {
    ...
    w: 15, at0: -1, at100: 1,
    get: (d) => d.market?.spxChg,
    value: (d) => pct(d.market?.spxChg), range: "−1%→+1%",
    detail: {
      es: "Cambio diario del S&P 500. Sube = apetito por riesgo. +1% = pleno, −1% = aversión.",
      en: "Daily S&P 500 change. Up = risk appetite. +1% = full, −1% = risk-off.",
    },
  },
  {
