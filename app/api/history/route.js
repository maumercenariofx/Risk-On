...
// Histórico de cierre USD/MXN (MXN=X) via Yahoo Finance v8 chart API
...
export async function GET(request) {
  ...
  try {
    const url = `https://query1.finance.yahoo.com/v8/finance/chart/MXN=X?range=${yRange}&interval=1d`;
