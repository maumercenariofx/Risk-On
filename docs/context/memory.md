...
- Hero: una esfera Rubik (el globo partido como cubo 3×3) es la intro en cada carga y se resuelve en el globo; el globo es la vista permanente (el control de dos fases y el cubo interactivo se probaron y se descartaron el 2026-09-21). Toda animación nueva del hero va en shader (uniforms), no en el loop de CPU sobre 72k-220k partículas: el reposo debe costar ~0 CPU (2026-09-21).
- Portafolio simulado (2026-09-21): 5 tramos × 200k, entrada/salida a las 7:00 CDMX (apertura de la vela de 13:00 UTC de MXN=X), 5 días hábiles, sin salida por la condición de invalidación. Nunca usar la vela 1d de Yahoo para MXN=X como "cierre": es una foto a hora variable; el cierre FX se toma de la vela horaria de 20:00 UTC.
