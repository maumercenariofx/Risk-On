...
- `[2026-08-07]` El view citó la inflación anual de julio en **3.10%**, que era la **primera quincena**; el dato de mes completo que INEGI publicó esa mañana fue **3.12%**. → REGLA: quincena y mes completo son series distintas. Al citar inflación, nombra cuál es.
- `[2026-08-*]` El carry de **2.87pp** (6.50 − 3.63) SÍ era correcto en todos los views de agosto. Se marcó como sospechoso en la auditoría solo porque el corpus afirmaba un recorte que nunca ocurrió. → REGLA: cuando dos datos del corpus se contradicen, verifica AMBOS contra la fuente antes de decidir cuál está mal — el equivocado puede ser el que parece obvio.
